...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pixel Pursuit — Recover the beacons. Extract alive." },
      { name: "description", content: "A browser survival hunt. Recover three signal beacons, break the predator's sight, and extract the cave before night takes the island." },
      { name: "author", content: "Adhrit Chopdekar" },
      { name: "theme-color", content: "#0b1220" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "mobile-web-app-capable", content: "yes" },
      { property: "og:title", content: "Pixel Pursuit" },
      { property: "og:description", content: "Recover the beacons. Outrun the predator. Extract before nightfall." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pixel Pursuit" },
      { name: "twitter:description", content: "A tiled jungle hunt in the browser. Two difficulties. Phone and PC." },
    ],
    links: [
